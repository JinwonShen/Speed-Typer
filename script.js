...
function startGame() {
  ...
  // 1. 타이머 시작 html - onfocus()
  clearInterval(timer); // 타이머 없애기(다시 시작)
...
function resetValues() {
  ...
  inputArea.value = "";
  quoteText.textContent = "아래를 클릭해서 게임을 시작해주세요.";
...
function finishGame() {
  ...
  // 마무리 텍스트 표시
  quoteText.textContent = "새 게임을 시작하려면 다시 시작을 클릭해주세요.";

  // 재시작 버튼 보여주기
  restartBtn.style.display = "block";

  // wpm word per minute 분당 문단 수 ?
  // cpm character per minutes 분당 글자 수?
